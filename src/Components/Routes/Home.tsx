    ...
    return (
        <div className="flex flex-col items-center w-full gap-[60px]">
            <div className='flex flex-col relative items-center w-full rounded-full'>
                ...
                <div className='flex z-[10] h-[216px] absolute top-32 w-[1074px] blur-[22px] backdrop-blur-[2px] aspect-square p-10 items-center justify-center rounded-[1074px] bg-[rgba(255,255,255,0.30]'>
                </div>
                ...
                <div className='z-[100] flex relative -mt-[22px]'>
                    <input className='w-[681px] h-[44px]  rounded-full placeholder:text-[#939393] border-[3px] border-[#D0D9F1] px-5 py-[10px]' placeholder={`Search for your brand's category`} />
                    <button className='absolute top-[8px] right-[12px]'>
