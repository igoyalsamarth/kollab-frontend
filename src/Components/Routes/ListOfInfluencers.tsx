...
export default function ListOfInfluencers() {
  return (
    <div className="flex px-6 w-[1440px]">
      <div className="grid grid-cols-4 gap-9 w-full">
        <div className="flex flex-col items-center p-5 gap-3 col-span-1 rounded-[20px] bg-[#FCD8DE] border border-[#F7A3B1] shadow-[4px_4px_0px_0px_#E0446F] ">
          ...
          <Link to='#' className="rounded-full text-white border border-[#550A1F] shadow-[4px_4px_0px_0px_#550A1F] bg-[#E0446F] px-[20px] py-[10px]">Open Profile</Link>
        </div>
      </div>
    </div>
  )
