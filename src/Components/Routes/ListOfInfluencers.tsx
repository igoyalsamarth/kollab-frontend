    ...
    <div className="flex w-[1440px] flex-col items-center gap-[50px]">
      <div className="flex flex-col items-center gap-[30px]">
        ...
        <div className="relative">
          <div className="w-[721px] capitalize text-[#2B3031] active:outline-[#2B3031] focus:outline-[#2B3031] px-5 py-[10px] border-[3px] border-[#D0D9F1] rounded-full">{id}</div>
          <Link to='/' className="absolute top-[12px] right-[12px]">
